...
nf5 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour5/')
nf4 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour4/')
nf3 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour3/')
nf2 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour2/')
nf1 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour1/')
nf_open = NeuralForecast.load(path='./checkpoints/test_runTFT_day_open/')
