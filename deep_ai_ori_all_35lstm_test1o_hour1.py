...
# モデルの学習
nf5.fit(df=train_df)
nf5.save(path='./checkpoints/test_runTFT_day_hour5/',
        model_index=None, 
        overwrite=True,
        save_dataset=True)
...
# モデルの学習
nf4.fit(df=train_df)
nf4.save(path='./checkpoints/test_runTFT_day_hour4/',
        model_index=None, 
        overwrite=True,
        save_dataset=True)
...
# モデルの学習
nf3.fit(df=train_df)
nf3.save(path='./checkpoints/test_runTFT_day_hour3/',
        model_index=None, 
        overwrite=True,
        save_dataset=True)
...
# モデルの学習
nf2.fit(df=train_df)
nf2.save(path='./checkpoints/test_runTFT_day_hour2/',
        model_index=None, 
        overwrite=True,
        save_dataset=True)
...
# モデルの学習
nf1.fit(df=train_df)
nf1.save(path='./checkpoints/test_runTFT_day_hour1/',
        model_index=None, 
        overwrite=True,
        save_dataset=True)
...
nf_open.save(path='./checkpoints/test_runTFT_day_open_1/',
        model_index=None, 
        overwrite=True,
        save_dataset=True)
