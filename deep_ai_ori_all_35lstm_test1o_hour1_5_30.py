...
# モデルの学習
#nf5.fit(df=train_df)
#nf5.save(path='./checkpoints/test_runTFT_day_hour5'+codem+'/',
#        model_index=None, 
#        overwrite=True,
#        save_dataset=True)
nf5 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour5'+codem+'/')
...
# モデルの学習
#nf4.fit(df=train_df)
#nf4.save(path='./checkpoints/test_runTFT_day_hour4'+codem+'/',
#        model_index=None, 
#        overwrite=True,
#        save_dataset=True)
nf4 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour4'+codem+'/')
# モデルのパラメータ
rnn_params = {
    'input_size': 20 * horizon, 
    'h': horizon, 
...
# モデルの学習
#nf3.fit(df=train_df)
#nf3.save(path='./checkpoints/test_runTFT_day_hour3'+codem+'/',
#        model_index=None, 
#        overwrite=True,
#        save_dataset=True)
nf3 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour3'+codem+'/')
# モデルのパラメータ
rnn_params = {
    'input_size': 20 * horizon, 
    'h': horizon, 
...
# モデルの学習
#nf2.fit(df=train_df)
#nf2.save(path='./checkpoints/test_runTFT_day_hour2'+codem+'/',
#        model_index=None, 
#        overwrite=True,
#        save_dataset=True)
nf2 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour2'+codem+'/')
# モデルのパラメータ
rnn_params = {
    'input_size': 20 * horizon, 
    'h': horizon, 
...
# モデルの学習
#nf1.fit(df=train_df)
#nf1.save(path='./checkpoints/test_runTFT_day_hour1'+codem+'/',
#        model_index=None, 
#        overwrite=True,
#        save_dataset=True)
nf1 = NeuralForecast.load(path='./checkpoints/test_runTFT_day_hour1'+codem+'/')
# モデルのパラメータ
rnn_params = {
    'input_size': 20 * horizon, 
    'h': horizon, 
...
#nf_open.save(path='./checkpoints/test_runTFT_day_open_1'+codem+'/',
#        model_index=None, 
#        overwrite=True,
#        save_dataset=True)
nf_open = NeuralForecast.load(path='./checkpoints/test_runTFT_day_open_1'+codem+'/')
#モデルロード#
