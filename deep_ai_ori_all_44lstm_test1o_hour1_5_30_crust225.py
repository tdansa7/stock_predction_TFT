    ...
    for df, group in grouped:
        ...
        for index, row in group.iterrows():
            ...
            if flag_a == 1 :
                ...
                if value_a < 0:
                    #value_b = plus_or*(((group.at[index, "Close"] - group.at[index, "Close_ave"])/group.at[index, "Close"])-0.001*(group.at[index, "Close"] - group.at[index, "Close_ave"])/abs(group.at[index, "Close"] - group.at[index, "Close_ave"]))
                    value_b = plus_or*(group.at[index, "Close"] - group.at[index, "Close_ave"])
                    if value_b>0:
                        flag_a = 1
