...
for codem in listcode:
    ...
    for unique_id in test_df['unique_id'].unique():
        ...
        y_pred = Y_hat_df[Y_hat_df.index == unique_id]["NHITS"]
    ...
    ax.plot(predicted["ds"], predicted["NHITS"], label='Predicted')
    # タイトルとラベルの設定
    ...
    for j in range(1, days_pred):
        ...
        last_price_open = last_price_open.iloc[0]['ave']*last_price_open.iloc[0]['Open'] + last_price_close
        last_price_1 = test_df.head(1)
        last_price_1 = last_price_1.iloc[0]['ave']*last_price_1.iloc[0]['hour1'] + last_price_close
        last_price_2 = test_df.head(1)
        last_price_2 = last_price_2.iloc[0]['ave']*last_price_2.iloc[0]['hour2'] + last_price_close
        last_price_3 = test_df.head(1)
        last_price_3 = last_price_3.iloc[0]['ave']*last_price_3.iloc[0]['hour3'] + last_price_close
        last_price_4 = test_df.head(1)
        last_price_4 = last_price_4.iloc[0]['ave']*last_price_4.iloc[0]['hour4'] + last_price_close
        last_price_5 = test_df.head(1)
        last_price_5 = last_price_5.iloc[0]['ave']*last_price_5.iloc[0]['hour5'] + last_price_close
        ...
        close_pricepre =  Y_hat_df_open.head(1)["NHITS"].values
        close_pricepre_open = close_pricepre[0]* ave_price
        close_pricepre =  Y_hat_df_1.head(1)["NHITS"].values
        close_pricepre_1 = close_pricepre[0]* ave_price
        close_pricepre =  Y_hat_df_2.head(1)["NHITS"].values
        close_pricepre_2 = close_pricepre[0]* ave_price
        close_pricepre =  Y_hat_df_3.head(1)["NHITS"].values
        close_pricepre_3 = close_pricepre[0]* ave_price
        close_pricepre =  Y_hat_df_4.head(1)["NHITS"].values
        close_pricepre_4 = close_pricepre[0]* ave_price
        close_pricepre =  Y_hat_df_5.head(1)["NHITS"].values
